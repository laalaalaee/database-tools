...
class DatabaseToolsPlugin implements Plugin
{
    ...
    private static ?bool $databaseBackupsTableExistsCache = null;

    private static function databaseBackupsTableExists(): bool
    {
        if (self::$databaseBackupsTableExistsCache === null) {
            self::$databaseBackupsTableExistsCache = Schema::hasTable('database_backups');
        }

        return self::$databaseBackupsTableExistsCache;
    }
}
